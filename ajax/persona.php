	...
	case 'listarp':
		$rspta=$persona->listarp();
 		...
 		while ($reg=$rspta->fetch_object()){
 			$data[]=array(
 				"0"=>(($_SESSION['rol']=='Administrador')?('<button class="btn btn-warning" style="margin-right: 3px; onclick="mostrar('.$reg->idpersona.')"><i class="fa fa-pencil"></i></button>'):'').
 					 (($_SESSION['rol']=='Administrador')?('<button class="btn btn-danger" onclick="eliminar('.$reg->idpersona.')"><i class="fa fa-trash"></i></button>'):''),
 				"1"=>$reg->nombre,
