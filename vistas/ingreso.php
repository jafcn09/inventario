...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Ingreso <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> <a href="../reportes/rptingresos.php" target="_blank"><button class="btn btn-info"><i class="fa fa-clipboard"></i> Reporte</button></a> <a href="../reportes/rptingresosDia.php" target="_blank"><button class="btn btn-warning"><i class="fa fa-clipboard"></i> Reporte del día</button></a></h1>
              ...
              <div class="panel-body" style="height: 100%;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    <label class="label_impuesto">Impuesto:</label>
      ...
      <div class="modal-dialog" style="width: 80%;">
        <div class="modal-content">
          ...
          <div class="modal-body table-responsive">
            <table id="tblarticulos" class="table table-striped table-bordered table-condensed table-hover w-100" style="width: 100%;">
              <thead>
                <th>Opciones</th>
                <th>Nombre</th>
                <th>Categoría</th>
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/ingreso16.js"></script>
<?php
}
ob_end_flush();
?>