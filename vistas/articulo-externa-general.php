              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Artículos generales para el administrador <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Precio(*):</label>
                            <input type="number" class="form-control" name="descripcion" step="any" id="descripcion" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" placeholder="Precio" autocomplete="off" required>
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<script type="text/javascript" src="scripts/articulo-externo-general4.js"></script>
<?php 
}
ob_end_flush();
?>