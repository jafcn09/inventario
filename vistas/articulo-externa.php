              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Artículos para el vendedor externo <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
...
<script type="text/javascript" src="scripts/articulo-externo6.js"></script>
<?php 
}
ob_end_flush();
?>