...
function init(){
	...
	$.post("../ajax/venta-externa.php?op=selectArticulo", function(r){
		$("#idarticulo").html(r);
...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/venta-externa.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
{
	bootbox.confirm("¿Estás seguro de eliminar la publicación?", function(result){
		if(result)
		{
...
{
	bootbox.confirm("¿Está Seguro de desactivar la publicación?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar la publicación?", function(result){
		if(result)
        {
